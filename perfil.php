...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/cssper.css">
...
<br>
	<div id="fondo">
        ...
        <a href="cerrar.php" id="perf2">Salir</a>
               <div id="subir"> <a href="" id="link2">Publicar</a>
               </div>
	...
	<div id="contenido">
        ...
        <center><h2 id=title>Historias publicadas:</h2></center>
        <center><div id="conte">
