...
<head>
	...
	<link rel="stylesheet" type="text/css" href="style/csscategorias.css">
...
<div id="subir"> <a href="publicar.php" id="link2">Publicar</a>
	...
	<div id="contenido">
		<center><font face="Dark Crystal" color="#fff" size="4"><h1 id="Categorías">Categorías:</h1></font></center>
		<select>
